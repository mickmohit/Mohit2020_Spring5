...
<body class="security-app">
	...
	<div class="lc-block">
            <form:form method="POST" modelAttribute="users" action="registrationProcess">
                <table >
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td><a href="home.jsp">Back to Login Page</a>
                        </td>
                    </tr>
                </table>
            </form:form>
   ...
   <c:if test="${requestScope.person ne null}">
				<div class="alert-danger">Sign Up Successful!</div>
			</c:if>
