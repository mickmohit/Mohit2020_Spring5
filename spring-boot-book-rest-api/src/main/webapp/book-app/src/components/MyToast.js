...
export class MyToast extends React.Component {
    ...
    render() {
        ...
        return (
          ...
          //  <div>{this.props.type} alert(this.props.type);</div>
                <Toast className={`border text-white ${this.props.children.type === "success" ? "border-success bg-success" : "border-danger bg-danger"}`} show={this.props.show}>
