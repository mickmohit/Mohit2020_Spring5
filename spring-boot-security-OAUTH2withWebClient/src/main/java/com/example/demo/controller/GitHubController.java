...
public class GitHubController {
    ...
    private List<String> fetchAllRepositories(OAuth2AuthorizedClient authorizedClient) {
        ...
        this.webClient
                ...
                .retrieve()//method is the simplest way to get the response body.
                .bodyToMono(ArrayNode.class) ///return string in Body<String> 
                .block()//to convert it string instead of Flux..
