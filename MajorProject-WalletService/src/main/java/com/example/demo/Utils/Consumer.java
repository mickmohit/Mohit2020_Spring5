...
public class Consumer {
    ...
    //KafkaConsumer listeners connect to Kafka brokers, listen to topics, 
    //and perform logic that is based on the arrival of messages to the topics in the Kafka brokers
